...
function processFile(file, updateProgress) {
    return new Promise((resolve, reject) => {
        ...
        async function processEntries(zipfile, parentPath) {
            zipfile.readEntry();
            ...
            zipfile.on('end', async() => {
                ...
                for (const folder of uniqueData) {
                    ...
                    const completedTasks = folders.indexOf(folder) + 1;
                    const totalTasks = folders.length;
